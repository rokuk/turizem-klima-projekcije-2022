...
Read data from NUTS-3 geopackage (borders between regions). Downloaded from auxillary files at [CDS](https://cds.climate.copernicus.eu/cdsapp#!/dataset/sis-tourism-snow-indicators?tab=doc).
...
```{r, dpi=300, fig.width=8, fig.height=4, eval=FALSE}
...
```{r, dpi=300, fig.width=8, fig.height=10, eval=FALSE}
for (j in 1:nrow(skidata)) {
...
```{r, dpi=300, fig.width=9, fig.height=4}
for (var in variables) {
