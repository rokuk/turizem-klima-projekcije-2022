...
CIT lookup table. See [CDS](https://cds.climate.copernicus.eu/cdsapp#!/dataset/sis-tourism-climate-suitability-indicators?tab=doc) and (De Freitas et al., 2008).
...
Calculate number of days in each CIT category, set category and month names:
...
Calculate number of days in each HCI category, set category and month names:
