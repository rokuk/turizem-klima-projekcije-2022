...
plotvarnames <- c("Days with at least 5 cm of natural snow", "Days with at least 30 cm of natural snow", "Snowfall precipitation from November to April (included)", "Potential snowmaking hours in November and December (WBT < -2\u00B0C)", "Potential snowmaking hours in November and December (WBT < -5\u00B0C)")
