...
percentile, `day_cat` is either "fair", "good" or "unf" (category determined based on CIT value), `datapoint` is the count of days in `day_cat` category for a specific month and metric, 
